  ...
  run: async ({ client, interaction }) => {
    try {
      ...
      if (type === "bypass") {
        ...
        interaction
          .editReply({ content: `array ${type} is now ${bypass.toString()}` })
          .catch(() =>
            console.log(
              `I don't have permission to send a message in ${channel} in ${guild.name}`
            )
        ...
        interaction
          .editReply({ content: `array ${type} is now ${trigger.toString()}` })
          .catch(() =>
            console.log(
              `I don't have permission to send a message in ${channel} in ${guild.name}`
            )
        ...
        interaction
          .editReply({
            content: `array ${type} is now ${removable.toString()}`,
          })
          .catch(() =>
            console.log(
              `I don't have permission to send a message in ${channel} in ${guild.name}`
      ...
      interaction
        .editReply({ content: `trying to modify, please wait...` })
        .catch(() =>
          console.log(
            `I don't have permission to send a message in ${channel} in ${guild.name}`
          )
    ...
    "verify": "${verifyrole}"
      ...
      if (logchannel == " ") {
        client.channels.cache
          .get(logchannel)
          .send({
            content: `config has been modified by \`\`${interaction.user.tag}\`\``,
            allowedMentions: { parse: [] },
          })
          .catch(() =>
            console.log(
