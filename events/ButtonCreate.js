    ...
    if (interaction.isButton()) {
        ...
        if (interaction.customId == 'lily weight') {
            ...
            const embed = new MessageEmbed()
                .setDescription(`Total weight is **\`\`${weight.total}\`\`**\n
                ...
                .setTitle(`profile: **\`\`${profile}\`\`** username: **\`\`${username}\`\`**`)
                .setColor(`RED`)
                .setAuthor(`${username}'s Lily Weight`,``, `https://sky.shiiyu.moe/stats/${username}/${profile}`)
        ...
        if (interaction.customId == 'senither weight') {
            ...
            const embed = new MessageEmbed()
                ...
                .setColor(`RED`)
                .setAuthor(`${username}'s senither Weight`,``, `https://sky.shiiyu.moe/stats/${username}/${nameprofile}`)
                .setThumbnail(`https://mc-heads.net/avatar/${uuid}/100`)
                .setTitle(`profile: **\`\`${nameprofile}\`\`** username: **\`\`${username}\`\`**`)
                //button
            const buttonrow = new MessageActionRow()
                .addComponents(
                    new MessageButton()
